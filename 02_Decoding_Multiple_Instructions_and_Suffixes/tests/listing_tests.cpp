...
struct DisasmTestMultipleInstructions : ::testing::TestWithParam<fs::path> {
    fs::path src;
    fs::path workDir;
    fs::path origBin;
    fs::path outAsm;
...
TEST_P(DisasmTestMultipleInstructions, AssembleOriginal) {
    AssembleOriginal();
}

TEST_P(DisasmTestMultipleInstructions, Disassemble) {
    AssembleOriginal();
    DisassembleOrigWithSource();
}

TEST_P(DisasmTestMultipleInstructions, Reassemble) {
    AssembleOriginal();
    DisassembleOrigWithSource();
    ReassembleOut();
}

TEST_P(DisasmTestMultipleInstructions, CompareBinariesDebugSource) {
    AssembleOriginal();
    DisassembleOrigWithSource();
    ReassembleOut();
...
TEST_P(DisasmTestMultipleInstructions, CompareBinariesDebugApplication) {
    AssembleOriginal();
...
INSTANTIATE_TEST_SUITE_P(
        Listings,
        DisasmTestMultipleInstructions,
